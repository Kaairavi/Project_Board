...
export function DeleteTaskButton({ task, projectId }: { task: any; projectId: number }) {
    ...
    return (
        <>
            <button
                ...
                disabled={isDeleting}
                className="p-1 text-slate-400 hover:bg-slate-100 hover:text-red-500 dark:hover:bg-slate-800 transition-colors rounded-md disabled:opacity-50"
                title="Delete Task"
            >
